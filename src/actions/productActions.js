...
export function fetchProducts() {
  ...
  return async function (dispatch) {
    ...
    await axios.get("http://eshopapi.test/api/products")  
...
return async function (dispatch) {
    ...
    await axios.post('http://eshopapi.test/api/product', product, {
     headers:headers
    }).then(product => {
...
return async function (dispatch) {
    ...
    await axios.delete('http://eshopapi.test/api/product'+id, {
     headers:headers
    })
      .then(product => {
        dispatch({
